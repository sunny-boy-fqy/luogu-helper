...
def expand_includes(file_path, processed_files=None, project_root=None):
    ...
    if project_root is None:
        # Try to find the project root (where include/ directory exists)
        current_dir = os.path.dirname(os.path.abspath(file_path))
        while current_dir != os.path.dirname(current_dir):  # Not at filesystem root
            if os.path.exists(os.path.join(current_dir, "include")):
    ...
    with open(file_path, "r", encoding="utf-8") as f:
        for line in f:
            ...
            if match:
                ...
                # Search paths - use relative paths for portability
                search_paths = [
                ...
                if full_include_path:
                    ...
                    output.append(
                        expand_includes(
                            full_include_path, processed_files, project_root
                        )
                    )
